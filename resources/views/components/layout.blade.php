            ...
            <div class="mt-8 md:mt-0 flex items-center">
                @auth
                    <x-dropdown>
                        ...
                        @can('admin')
                            <x-dropdown-item href="{{ route('admin.posts.index') }}" :active="request()->routeIs('admin.posts.index')">Dashboard</x-dropdown-item>
                            <x-dropdown-item href="{{ route('admin.posts.create') }}" :active="request()->routeIs('admin.posts.create')">Create a Post
                            </x-dropdown-item>
                        @endcan
